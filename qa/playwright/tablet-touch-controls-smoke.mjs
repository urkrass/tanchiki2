...
try {
  ...
  const modStart = railToViewport(standardFireRailBox, 84, 385)
  const modHalfPoint = railToViewport(standardFireRailBox, 84, 345)
  const modEnd = railToViewport(standardFireRailBox, 84, 305)
  ...
  const mirroredModStart = railToViewport(mirroredFireRailBox, 84, 385)
  const mirroredModEnd = railToViewport(mirroredFireRailBox, 84, 305)
  ...
  const overdriveModStart = railToViewport(overdriveFireRail, 84, 385)
  const overdriveModEnd = railToViewport(overdriveFireRail, 84, 305)
  ...
  const pontoonModStart = railToViewport(pontoonFireRail, 84, 385)
  const pontoonModEnd = railToViewport(pontoonFireRail, 84, 305)
