...
- Focused layout/accessibility/readability validation passes at 3 files / 9 tests. Full `npm.cmd run validate` passes at 62 files / 575 tests with production build, server integration, and harness checks.
