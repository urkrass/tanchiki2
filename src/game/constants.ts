...
export const TANK_SELECT_THEATER_FOG_X = TANK_SELECT_CONTENT_X + 7
export const TANK_SELECT_THEATER_FOG_Y = TANK_SELECT_THEATER_Y + 25
export const TANK_SELECT_THEATER_FOG_WIDTH = TANK_SELECT_CONTENT_WIDTH - 14
export const TANK_SELECT_THEATER_FOG_HEIGHT =
  TANK_SELECT_THEATER_HEIGHT - 43
