...
import { BASE_MAX_HP, CAMPAIGN_LEVELS, CAMPAIGN_MAP_COLS, CAMPAIGN_MAP_ROWS, DEFAULT_OBJECTIVE, ECHO_QUARRY_LEVEL_ID, ECHO_QUARRY_MAP_COLS, ECHO_QUARRY_MAP_ROWS, createTiles, getWaterNeighbors } from './level.ts'
...
describe('TanchikiGame real-game upgrade', () => {
  ...
  it('unlocks the campaign expansion level for saves that already cleared levels 1-8', () => {
    const saveData = createDefaultSaveData()
  ...
  it('respawns killed teammates from a finite reserve without spending enemy tickets or awarding player rewards', () => {
  ...
  it('loads old saved teammate runs without friendlyRemaining', () => {
    const store = new MemorySaveStore()
