...
const BATTLEFIELD_BIOME_PROPS: BattlefieldPropInstance[] = [
  ...
  { id: 'qa-tree-large', spriteId: 'tree_large', x: 6, y: 4 },
  { id: 'qa-pine', spriteId: 'pine', x: 8, y: 4 },
  { id: 'qa-palm', spriteId: 'palm', x: 10, y: 4 },
  { id: 'qa-rock-small-cracked', spriteId: 'rock_small', x: 13, y: 2, variant: 'cracked' },
  { id: 'qa-rock-small-moss', spriteId: 'rock_small', x: 15, y: 2, variant: 'moss' },
  { id: 'qa-rock-small-snow', spriteId: 'rock_small', x: 17, y: 2, variant: 'snow' },
  { id: 'qa-rock-small-angled', spriteId: 'rock_small', x: 19, y: 2, variant: 'angled' },
  { id: 'qa-rock-large-cracked', spriteId: 'rock_large', x: 13, y: 5, variant: 'cracked' },
  { id: 'qa-rock-large-moss', spriteId: 'rock_large', x: 15, y: 5, variant: 'moss' },
  { id: 'qa-rock-large-snow', spriteId: 'rock_large', x: 17, y: 5, variant: 'snow' },
  { id: 'qa-rock-large-angled', spriteId: 'rock_large', x: 19, y: 5, variant: 'angled' },
  { id: 'qa-stump', spriteId: 'stump', x: 4, y: 6 },
  { id: 'qa-log-h', spriteId: 'fallen_log_horizontal', x: 6, y: 6 },
  { id: 'qa-log-v', spriteId: 'fallen_log_vertical', x: 8, y: 6 },
  { id: 'qa-rock-small', spriteId: 'rock_small', x: 10, y: 6 },
  { id: 'qa-rock-large', spriteId: 'rock_large', x: 12, y: 6 },
  { id: 'qa-reeds', spriteId: 'reeds_cluster', x: 14, y: 6 },
  { id: 'qa-bush', spriteId: 'bush', x: 16, y: 6 },
  { id: 'qa-dry-bush', spriteId: 'dry_bush', x: 4, y: 8 },
  { id: 'qa-snow-bush', spriteId: 'snow_bush', x: 6, y: 8 },
  { id: 'qa-crate-wood', spriteId: 'crate_wood', x: 8, y: 8 },
  { id: 'qa-crate-metal', spriteId: 'crate_metal', x: 10, y: 8 },
  { id: 'qa-fuel-barrel', spriteId: 'fuel_barrel', x: 12, y: 8 },
  { id: 'qa-sandbags', spriteId: 'sandbags', x: 14, y: 8 },
  { id: 'qa-barbed-wire', spriteId: 'barbed_wire', x: 16, y: 8 },
  { id: 'qa-tank-wreck', spriteId: 'tank_wreck', x: 4, y: 10 },
  { id: 'qa-broken-turret', spriteId: 'broken_turret', x: 6, y: 10 },
  { id: 'qa-crater-small', spriteId: 'crater_small', x: 8, y: 10 },
  { id: 'qa-crater-large', spriteId: 'crater_large', x: 10, y: 10 },
  { id: 'qa-rubble', spriteId: 'rubble_pile', x: 12, y: 10 },
  { id: 'qa-roadblock', spriteId: 'roadblock', x: 14, y: 10 },
  { id: 'qa-hedgehog', spriteId: 'czech_hedgehog', x: 16, y: 10 },
  { id: 'qa-relay-tower', spriteId: 'relay_tower', x: 4, y: 13 },
  { id: 'qa-portable-relay', spriteId: 'portable_relay', x: 6, y: 13 },
  { id: 'qa-broken-relay', spriteId: 'broken_relay', x: 8, y: 13 },
  { id: 'qa-antenna-mast', spriteId: 'antenna_mast', x: 10, y: 13 },
  { id: 'qa-generator', spriteId: 'generator', x: 12, y: 13 },
  { id: 'qa-emp-emitter', spriteId: 'emp_emitter', x: 14, y: 13 },
  { id: 'qa-signal-jammer', spriteId: 'signal_jammer', x: 16, y: 13 },
  { id: 'qa-field-lamp', spriteId: 'field_lamp', x: 12, y: 15 },
  { id: 'qa-warning-sign', spriteId: 'warning_sign', x: 14, y: 15 },
]
...
export const ECHO_QUARRY_ROWS = [
  'SSSSSSSSSgggggggggSSSSSSSSSTTTTTTTTT',
  'S.hhhhh.Sg.......gS...R...STTTrrrTTT',
  '..h.B.h..g..xxx..g....g....T..rrr..T',
  'BBh.B.hBBg.x...x.gBBR...DBB..rrrrr..',
  '..h...h..g.x.m.x.g...mmm...T.rrrrr.T',
  'SShBBBhSSg.x.m.x.g....m.......TTT...',
  '..hhhhhh.g.x...x.gSSS...SSS..SS.SS..',
  'BB.SS.hBBg..xxx..g...ddd...T.......T',
  '..h...h..ggggggggg.ddddddd.TTT...TTT',
  'SSh.S.hSS...ssss...dxxxxx..rrr...rrr',
  '..h.S.h....ss..ss..d.....d.rTT...TTr',
  'BBh.S.hBB..ss..ss..ddd.ddd.rT.....Tr',
  '..hhhhhh.....==......m.m...rr..s..rr',
  'SSS..SSS.BBBB==BBBxxxm.mxxxrr..s..rr',
  '....h........==......m.m...rr..s..rr',
  'BB..h..BB..ddddddd...mmm...TT..s..TT',
  '..hhhhh....dxxxxx...d...d..TT..s..TT',
  'S.h...h.S..d.....d..ddd.d..rr.....rr',
  '..h.B.h....ssssss.BBB...BBBrrr.T.rrr',
  'BBh.B.hBB..s....s....ggg...TTT...TTT',
  '..h...h....s.xx.s....g.g......TTT...',
  'SShhh.hSS..s.xx.s.SS.g.g.SS..SS.SS..',
  '....h......s....s....g.g...T..rrr..T',
  'BBBBhBBBB..ssssss....ggg...T.rrrrr.T',
  '....h....====m========m.......TTT...',
  'A...====.SSS.m.SSS====m========TT...',
  '....====....mmm.A.....m....SS..TT..S',
  '....====.........====m====..TT......',
...
const ECHO_QUARRY_FRIENDLY_LOADOUTS = ECHO_QUARRY_FRIENDLY_SPAWNS.map((spawn, index) => ({
  id: `echo-ally-${index + 1}`,
  classId: (['scout', 'engineer', 'battle'] as const)[index % 3] ?? 'scout',
  spawn,
  dir: 'up' as const,
}))
...
export const CAMPAIGN_LEVELS: LevelDefinition[] = [
  ...
  },
  {
    ...
    name: 'Echo Quarry',
    briefing: 'Mode: Team Battle. A ruined quarry splits the fight between echo-maze corridors, exposed ricochet lanes, and a noisy eastern grove.',
    objective: {
      mode: 'team-battle',
      label: 'Team Battle',
      briefing: 'Break the 30-tank enemy roster while ten allied tanks hold the field from a finite reserve.',
      winCondition: 'Destroy the enemy roster before your lives and allied reserve are exhausted.',
