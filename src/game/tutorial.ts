...
export const TUTORIAL_MISSIONS: TutorialMissionDefinition[] = [
  {
    id: 1,
    name: 'First Gear',
    subtitle: 'Defense fundamentals',
    objectiveMode: 'defense',
    briefing: 'Learn movement, turning, fire discipline, ammunition, cover, and defense of the eagle base.',
    recommendedClass: 'engineer',
    recommendedMod: 'overdrive',
    actors: [INSTRUCTORS[1]!],
    level: {
      id: 1,
      name: 'First Gear',
      briefing: 'Actual runs a live-fire defense drill with two carefully underachieving hostiles.',
      objective: {
        mode: 'defense',
        label: 'Defense Drill',
        briefing: 'Learn the controls, then defend the eagle base.',
        winCondition: 'Complete the handling checks and destroy two hostiles.',
      },
      biome: 'temperate',
      rows: [
        '.....................',
    ...
    steps: [
      {
        ...
        dialogue: [
          { speaker: 'Actual', text: 'Welcome to Boot Camp. The fuel is real; the paperwork is tactical camouflage.' },
          { speaker: 'Spanner', text: 'Confirm when ready. Then move, turn, and keep the eagle base behind you.' },
        ],
      },
      {
        id: 'move',
        ...
        dialogue: [{ speaker: 'Spanner', text: 'Ease forward one cell. A stationary tank is cover with ambitions.' }],
      },
      {
        id: 'turn',
        goal: 'Turn to face a new direction.',
        trigger: { kind: 'turn', count: 1 },
        dialogue: [{ speaker: 'Actual', text: 'Traverse first. Walls do not accept apologies.' }],
      },
      {
        id: 'fire',
        goal: 'Fire one shell and observe the reload and ammunition readout.',
        trigger: { kind: 'fire', count: 1 },
        dialogue: [{ speaker: 'Spanner', text: 'One shell, one decision. The depot calls random firing a donation.' }],
      },
      {
        id: 'defend',
        goal: 'Use cover and destroy both training hostiles.',
        trigger: { kind: 'destroy', count: 2 },
        dialogue: [{ speaker: 'Actual', text: 'Defend the eagle. The targets have been ordered to lose professionally.' }],
        completionDialogue: [{ speaker: 'Spanner', text: 'Range clear. The eagle survives, and so does most of the paperwork.' }],
      },
    ],
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        completionDialogue: [{ speaker: 'Actual', text: 'Offline simulation complete. No matchmaking server was harmed.' }],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        trigger: { kind: 'flag-pickup' },
        dialogue: [{ speaker: 'Actual', text: 'Manual drop confirmed. Move clear of the flag, then drive back across it to recover.' }],
      },
      {
        id: 'capture',
        ...
        completionDialogue: [{ speaker: 'Actual', text: 'Capture recorded. Property dispute resolved by scoreboard.' }],
      },
    ],
  },
  {
    ...
    level: {
      id: 5,
      name: 'No Friendlies on the Form',
      briefing: 'Every contact is hostile. Actual recommends checking twice and shooting once.',
      objective: {
        mode: 'ffa',
        label: 'Free For All',
    ...
    steps: [
      {
        ...
        trigger: { kind: 'confirm' },
        dialogue: [{ speaker: 'Actual', text: 'No friendlies are listed. If someone waves, confirm whether it is a turret.' }],
      },
      {
        id: 'priority',
      ...
      },
      {
        ...
        trigger: { kind: 'destroy', count: 1 },
        dialogue: [{ speaker: 'Actual', text: 'Two confirmed. The form remains pleasantly short.' }],
        completionDialogue: [{ speaker: 'Actual', text: 'Free For All complete. The deconfliction meeting has been cancelled.' }],
      },
    ],
  },
  {
    ...
    steps: [
      {
        ...
        trigger: { kind: 'confirm' },
        dialogue: [{ speaker: 'Actual', text: 'Final drill. Knock before breaching; it makes the breach seem organized.' }],
      },
      {
        id: 'reveal',
      ...
      },
      {
        ...
        completionDialogue: [
          ...
          { speaker: 'Actual', text: 'Boot Camp complete. Campaign command now has one fewer excuse.' },
        ],
      },
    ],
  },
