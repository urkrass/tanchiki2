...
export const TUTORIAL_MISSIONS: TutorialMissionDefinition[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        dialogue: [{ speaker: 'Spanner', text: 'Good. A stationary tank is cover with ambitions.' }],
      },
      {
        id: 'turn',
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        dialogue: [{ speaker: 'Needle', text: 'Link established. The fog has filed a formal complaint.' }],
      },
      {
        id: 'contacts',
        goal: 'Use shared vision to destroy two contacts.',
        trigger: { kind: 'destroy', count: 2 },
        dialogue: [{ speaker: 'Actual', text: 'Offline simulation complete. No matchmaking server was harmed.' }],
      },
    ],
  },
  {
    ...
    level: {
      ...
      enemySpawns: [{ x: 4, y: 1 }, { x: 10, y: 1 }, { x: 16, y: 1 }],
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        dialogue: [{ speaker: 'Needle', text: 'Flag aboard. Choose cover; ceremony is not armor.' }],
      },
      {
        id: 'drop',
        goal: 'Manually drop the flag, then recover it.',
        trigger: { kind: 'flag-drop' },
        dialogue: [{ speaker: 'Actual', text: 'Manual drop confirmed. Recovery drill follows immediately.' }],
      },
      {
        id: 'recover',
        goal: 'Recover the dropped flag.',
        trigger: { kind: 'flag-pickup' },
        dialogue: [{ speaker: 'Brick', text: 'Recovered. The flag has learned nothing.' }],
      },
      {
        id: 'capture',
        goal: 'Escort the flag to the blue base.',
        trigger: { kind: 'flag-capture', count: 1 },
        dialogue: [{ speaker: 'Actual', text: 'Capture recorded. Property dispute resolved by scoreboard.' }],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    level: {
      ...
      playerSpawn: { x: 10, y: 15 },
      enemySpawns: [{ x: 4, y: 4 }, { x: 16, y: 4 }, { x: 10, y: 6 }],
