...
Tanchiki2 развивается как кооперативная тактическая игра. Текущий `main` уже содержит полноценную offline-кампанию с союзными ботами и локальный server-authoritative online-прототип, но production multiplayer пока не развёрнут.
...
- decoy, mine, noise, steel trap и tripwire как единая система полевых устройств;
